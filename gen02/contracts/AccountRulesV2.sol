...
interface AccountRulesV2 is AccountRulesProxy, IAccessControl {
    ...
    event AccountHashUpdated(address account, uint orgId, bytes32 dataHash, address admin);
    ...
    function updateLocalAccountHash(address account, bytes32 dataHash) external;
