...
Funcionalidade: Governança do permissionamento - Cenários de votação
  ...
  Cenário: Aprovação de proposta com 3 organizações no último voto
    ...
    Quando a conta "0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199" adiciona a organização "Prodemge" e direito de voto "true"
    Então a organização 3 é "Prodemge" e direito de voto "true"
